    ...
    <body class="A5 landscape">
            ...
            <section class="sheet flex flex-col p-4">
                <div class="main-content flex h-full flex-col border-2 border-black">
                    ...
                    <div class="flex w-full justify-between">
                        <span class="flex px-8 py-2">Stundent must carry the admit card during the examination
                            time.</span>
        ...
        <div class="w-3xl mx-auto flex flex-col gap-2">
            ...
            <a href="{{ route('students.index') }}"
                ...
                to List</a> --}}
            <div class="fixed bottom-0 right-0 gap-5 md:right-16 md:top-16">
                <a href="{{ route('students.index') }}"
                    class="inline-block rounded-lg py-2 text-center text-blue-500 print:hidden"
                    rel="noopener noreferrer">Back
                    to List</a>
                <button
                    class="inline-block rounded-lg bg-blue-500 px-4 py-2 text-center text-white hover:bg-blue-600 active:bg-blue-700 print:hidden"
                    rel="noopener noreferrer">Print</button>
            </div>
        </div>
    </body>
